...
var Element = function (_a) {
    var list = _a.list, id = _a.id, change = _a.change, value = _a.value, placeholder = _a.placeholder, inputPlaceholder = _a.inputPlaceholder, emptyText = _a.emptyText, multiple = _a.multiple, clear = _a.clear, selectedCallback = _a.selectedCallback;
    return _jsx(Autocomplete, { list: list, id: id, change: change, value: value, placeholder: placeholder, inputPlaceholder: inputPlaceholder, emptyText: emptyText, multiple: multiple, clear: clear, selectedCallback: selectedCallback }, void 0);
};
afterEach(cleanup);
describe('Autocomplete with icon', function () {
    ...
    it('With selected', function () {
        var utils = render(_jsx(Element, { id: 'myName', list: lists, change: testFunction, value: [
                { value: 'Nimesh', label: 'Nimesh', id: 'Nimesh', icon: 'https://unprint.pt/static/media/logo.4af0ed03.png' }
