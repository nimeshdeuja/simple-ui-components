...
var Button = function (_a) {
    var className = _a.className, _b = _a.theme, theme = _b === void 0 ? 'default' : _b, type = _a.type, clicked = _a.clicked, icon = _a.icon, text = _a.text, fullWidth = _a.fullWidth, style = _a.style;
