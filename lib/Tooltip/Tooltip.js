...
var getPoints = function (el, tt, placement, space) {
    ...
    return (function recursive(placement) {
        ...
        if (recurCounter < 2) {
            if ((pos.isHorizontal() && (pt.x < box.l || pt.x > box.r)) ||
...
export var Tooltip = function (_a) {
    var text = _a.text, _b = _a.placement, placement = _b === void 0 ? "top" : _b, _c = _a.space, space = _c === void 0 ? 10 : _c, children = _a.children, _d = _a.disabled, disabled = _d === void 0 ? false : _d, _e = _a.click, click = _e === void 0 ? false : _e;
