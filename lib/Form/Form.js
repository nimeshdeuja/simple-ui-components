    ...
    switch (type) {
        ...
        case 'select':
            ...
            if (inputElement) {
                ...
                selectElement = _jsx("select", __assign({ ref: ref }, inputElement, { children: selectOptions }), void 0);
            }
